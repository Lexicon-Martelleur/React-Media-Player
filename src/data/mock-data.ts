...
import { audioTracks, images } from "../assets";
...
export const playlistOneData: IPlaylistItem[] = [
  {
    ...
    audio: { src: audioTracks.gratefuleDead.src, type: "audio/mp3"}
  },
  {
    id: 2,
    artist: "Queen",
    ...
    audio: { src: audioTracks.desertRain.src, type: "audio/mp3"}
  },
  {
    id: 3,
    ...
    audio: { src: audioTracks.philLeshAndFriends.src, type: "audio/mp3"}
  },
  {
    id: 4,
    artist: "Adele",
